...
router.get('/', function(req, res, next) {
  connection.query('SELECT c.id, c.fecha, ma.nombre, med.nombres, med.consultorio FROM cita_medica c, pacientes ma, medicos med WHERE ma.cedula=id_paciente AND med.cedula=id_medico;', function(error, results) {
    if (error) {
